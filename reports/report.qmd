...
SELECT *
FROM world_bank_data.wdi_country
WHERE country_id NOT LIKE 'X%' AND (country_region = '' OR country_income = '' OR country_name IN ('World','High income','Upper middle income','Lower middle income','Low income'));
""")
```
...
SELECT *
FROM world_bank_data.wdi_country
WHERE NOT (country_id NOT LIKE 'X%' AND (country_region = '' OR country_income = '' OR country_name IN ('World','High income','Upper middle income','Lower middle income','Low income')));
""")
