...
SELECT *
FROM world_bank_data.wdi_country
WHERE `Short Name` IN ('World', 'High income', 'Upper middle income', 'Lower middle income', 'Low income')
  OR `Region` = ''
  OR `Income Group` = '';
""")
...
FROM world_bank_data.wdi_country
WHERE NOT (
    `Short Name` IN ('World', 'High income', 'Upper middle income', 'Lower middle income', 'Low income')
    OR `Region` = ''
    OR `Income Group` = ''
);
""")
