...
SELECT *
FROM world_bank_data.wdi_country
WHERE country_name IN ('World', 'High income', 'Upper middle income', 'Lower middle income', 'Low income')
  OR country_region = ''
  OR country_income = '';
""")
```
...
AND NOT (country_name IN ('World', 'High income', 'Upper middle income', 'Lower middle income', 'Low income'));
""")
